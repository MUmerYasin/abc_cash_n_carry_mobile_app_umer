...
// String? whatIsYourDayJob = '';
                      ...
                      children: [
                        Container(
                          ...
                          child: Text(
                            aBC_StringGender,
                            style: TextStyle(
                                color: TextFieldTitleColor, fontSize: 14.0,
                            ),
                          ),
                        ),
                        Padding(
                          ...
                          child: DropdownButton<String>(
                            ...
                            hint: Padding(
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                    color: Color(0xFF727272), fontSize: 14.0,
                                ),
                                // style: TextStyle(),
                              ),
                            ),
  ...
  bool _validateCompleteForm() {
    if (_nameTextFieldController.text.isEmpty) {
      ...
      return false;
    } else if (_emailTextFieldController.text.isEmpty || _validateEmail(_emailTextFieldController.text)) //!_validateEmail(_emailTextFieldController.text)
    {
