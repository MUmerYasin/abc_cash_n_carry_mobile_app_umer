...
// const TextStyle signUpStyle=TextStyle( fontFamily: 'Segoe UI',);
...
const TextStyle loginTextFieldStyle=TextStyle(color: TextFieldTitleColor,fontSize: 14.0,height: 2.5,letterSpacing: -0.3376470069885254, fontFamily: textFontFamilySegoeUI,);
